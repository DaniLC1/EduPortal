...
A Tájékoztató módosításai a http://localhost:8080/EduPortal/index.php oldalon történő közzététellel lépnek hatályba. 

## Az Adatkezelő adatai

Adatkezelő: Kiszel Dániel
Székhely: 6763 Szatymaz IV. Körzet Tanya 127/c 
Email: kiszel1dani@gmail.com 
...
**Az alábbiak eltérhetnek rendszerenként, néhány tipikus eset felsorolása következik:**

1. Kapcsolatfelvétel emailben

- Adatkezelés célja: Kapcsolat felvétel email formájában.
...
2. Rendszerüzenetek küldése ügyfelek részére  

- Adatkezelés célja: Rendszerüzenetek küldése ügyfelek részére (pl. lejáró szolgáltatásról, karbantartás).
- Adatkezelés jogalapja: GDPR 6. cikk (1) bekezdés b) pont: a szerződés teljesítése vagy a szerződés megkötését megelőzően az Érintett kérésére történő lépések megtételéhez szükséges. 
...
- Személyes adatok köre: Név, email cím, Felhasználónév.
...
- Címzettek: Az Adatkezelő az alábbi Adatfeldolgozót veszi igénybe: Példa: *Avatárok megjelenítése Gravatar integráción keresztül:  Aut O’Mattic A8C Ireland Ltd (székhely: Grand Canal Dock, 25 Herbert Pl Dublin, D02 AY86, Írország)*.
...
A további eseteket az adott alkalmazás sajátosságainak a fenti rendszer szerint kell definiálni. Ilyenek lehetnek a szerződéssel kapcsolatos kapcsolattartás, közösségi média használata, számlázás, stb.
...
### Fizetések kezelésével kapcsolatos adattovábbítás 

**Az alábbi példa a Stripe szolgáltatóra vonatkozik, a megfelelő szolgáltató alapján ez átírandó.**
...
A személyes adatokhoz csak a rendszer adminisztrátorai férhetnek hozzá a feladataik ellátásához szükséges mértékben.
...
Jelen rendszer nem végez kereskedelmi profilalkotást

Elemzés kizárólag a rendszerhasználat javítására, oktatási célokra 
...
Amennyiben az adatkezelés jogalapja az Adatkezelő jogos érdeke, az érdekmérlegelési teszt kérésre elérhető az Adatkezelő elérhetőségein. 

## Az Adatkezelési tájékoztató frissítése 

Az Adatkezelő fenntartja a jogot, hogy a Tájékoztatót egyoldalúan módosítsa jogszabályi változás vagy egyéb körülmény esetén.

**Hatályos:**

2025.11.23.-tól visszavonásig.
